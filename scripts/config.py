...
# Gitignored, regenerated by any run: the full (pre-export) analysis matrix per
# corpus, so `tools/relayout.py` can rebuild full-vector t-SNE layouts without a
# GPU pass. See embeddings.vectors.cache_analysis_matrix.
VECTORS_CACHE = _SCRIPTS / ".cache" / "vectors"
