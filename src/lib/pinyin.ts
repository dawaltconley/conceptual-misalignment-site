 ...
 * A reading is supplied by the caller (`CC-CEDICT` via
 * `@build/cedict` already has one for every character in the corpus) and
 * expanded into the forms someone might type.
 */
