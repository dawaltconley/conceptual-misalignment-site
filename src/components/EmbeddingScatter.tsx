...
// const CORPORA = ['chinese', 'english'] satisfies (keyof MasterTerm)[]
// type Corpus = MasterTerm[(typeof CORPORA)[number]]
// type Foo = MasterTerm["chinese"]["embeddings"]
//     const DATATYPES = [
//       'embeddings',
//       'similarity',
//       'cooccurrence',
//     ] satisfies (keyof Corpus)[]
